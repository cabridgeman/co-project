...
completedata <<- completedata %>%
  mutate(ln_Region_Weighted_Average_Salary = ifelse(Cluster=='Overseas' & Num==observation, region_weighted_average, ln_Region_Weighted_Average_Salary))
...
x <- c(1:29)
y <- completedata$ln_Region_Weighted_Average_Salary[91:119]
print(y)
...
completedata <- completedata %>%
  mutate(ln_Region_Weighted_Average_Salary_ncsi = ifelse(Cluster == 'Overseas', NA, ln_Region_Weighted_Average_Salary_ncsi))

completedata$ln_Region_Weighted_Average_Salary_ncsi[overseas_indices] <- spline_values
...
write_xlsx(completedata, "outputs/results_overseas_region_weights.xlsx")
