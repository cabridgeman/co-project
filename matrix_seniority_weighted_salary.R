...
completedata <<- completedata %>%
  mutate(ln_Seniority_Weighted_Average_Salary = ifelse(Cluster=='Matrix' & Num==observation, seniority_weighted_average, ln_Seniority_Weighted_Average_Salary))
...
x <- c(1:29)
y <- completedata$ln_Seniority_Weighted_Average_Salary[1:29]
print(y)
...
completedata <- completedata %>%
  mutate(ln_Seniority_Weighted_Average_Salary_ncsi = ifelse(Cluster == 'Matrix', NA, ln_Seniority_Weighted_Average_Salary_ncsi))

completedata$ln_Seniority_Weighted_Average_Salary_ncsi[matrix_indices] <- spline_values
...
write_xlsx(completedata, "outputs/results_matrix_seniority_weights.xlsx")
